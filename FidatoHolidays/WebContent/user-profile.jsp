...
<!-- Mirrored from remtsoy.com/tf_templates/traveler/demo_v1_7/user-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 16 Apr 2019 14:11:19 GMT -->
<head>
...
<body>
	...
	<%
	String mob=request.getParameter("mbl").toString();
	String mail="";
	
	//System.out.println("userprof-"+mob);
	/* if(session.getAttribute("mobile")==null||session.getAttribute("mobile")==""||session.getAttribute("email")==null||session.getAttribute("email")=="" ){
		System.out.println("userprof-"+mob);
		...
		PreparedStatement ps=con.prepareStatement("SELECT * FROM FID_REG WHERE MOBILE='"+mob+"' OR EMAIL='"+mail+"'");
        ...
        <div class="demo_changer" id="demo_changer">
            ...
            <div class="form_holder">
                ...
                <div class="predefined_styles" id="styleswitch_area">
                    <a class="styleswitch" href="user-profilec392.html?default=true" style="background:#ED8323;"></a>
                                ...
                                <ul class="top-user-area-list list list-horizontal list-border">
                                    <li class="top-user-area-avatar">
                                        <a href="user-profile.jsp">
                                            <img class="origin round" src="img/amaze_40x40.jpg" alt="Image Alternative text" title="AMaze" /><%=rs.getString("first_name") %>&nbsp;<%=rs.getString("last_name") %></a>
                                    </li>
                    ...
                    <ul class="slimmenu" id="slimmenu">
                        <li><a href="index.jsp">Home</a>
                            <!-- <ul>
                                ...
                                <li><a href="index.jsp">Layout 1</a>
                                </li>
                                <li><a href="index.jsp">Layout 2</a>
                                </li>
                                <li><a href="index.jsp">Layout 3</a>
                                </li>
                                <li><a href="index.jsp">Layout 4</a>
                                </li>
                                <li><a href="index.jsp">Layout 5</a>
                                </li>
                                <li><a href="index.jsp">Layout 6</a>
                                </li>
                                <li><a href="index.jsp">Layout 7</a>
                                </li>
                            </ul>
                        </li>
                        <li class="active"><a href="#">Pages</a>
                            <ul>
                                ...
                                <li class="active"><a href="user-profile.jsp">User Profile</a>
                                    <ul>
                                        <li class="active"><a href="user-profile.jsp">Overview</a>
                                        </li>
                                        <li><a href="user-profile-settings.jsp">Settings</a>
                                        </li>
                                        <li><a href="user-profile-photos.jsp">Photos</a>
                                        </li>
                                        <li><a href="user-profile-booking-history.jsp">Booking History</a>
                                        </li>
                                ...
                                <li><a href="blog.html">Blog</a>
                                    <ul>
                                        ...
                                        <li><a href="blog-sidebar-left.jsp">Sidebar Left</a>
                                        </li>
                ...
                <div class="col-md-3">
                    <aside class="user-profile-sidebar">
                        <div class="user-profile-avatar text-center">
                            ...
                            <p><br>Mobile:<%=rs.getString("mobile") %><br>Email:<%=rs.getString("email") %></p>
                        </div>
                        <ul class="list user-profile-nav">
                            <li><a href="user-profile.jsp"><i class="fa fa-user"></i>Overview</a>
                            </li>
                            <li><a href="user-profile-settings.jsp"><i class="fa fa-cog"></i>Settings</a>
                            </li>
                            <li><a href="user-profile-photos.jsp"><i class="fa fa-camera"></i>My Travel Photos</a>
                            </li>
                            <li><a href="user-profile-booking-history.jsp"><i class="fa fa-clock-o"></i>Booking History</a>
                            </li>
                            <li><a href="user-profile-cards.jsp"><i class="fa fa-credit-card"></i>Credit/Debit Cards</a>
                            </li>
                            <li><a href="user-profile-wishlist.jsp"><i class="fa fa-heart-o"></i>Wishlist</a>
                            </li>
                        </ul>
                    </aside>
                </div>
...
<!-- Mirrored from remtsoy.com/tf_templates/traveler/demo_v1_7/user-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 16 Apr 2019 14:11:21 GMT -->
</html>
