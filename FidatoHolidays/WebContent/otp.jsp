   ...
   <!-- FACEBOOK WIDGET -->
    ...
    <div class="global-wrap">
		...
		%>
                                ...
                                <div class="col-md-4">
                                    <h3 class="mb15">Traveler - Login register</h3>
                                    
                                        <div class="form-group form-group-ghost form-group-icon-left"><i class="fa fa-user input-icon input-icon-show"></i>
                                            <label>Enter Mobile Number</label>
                                            <input type="number" class="form-control" value="<%=mob%>" readonly="readonly" id="mobVal">
                                        </div>
                                      <div class="form-group form-group-ghost form-group-icon-left"><i class="fa fa-user input-icon input-icon-show"></i>
                                            <label>Enter OTP</label>
                                           <input type="text" class="form-control" name="" id="otpVal">
				<label style="color: red;visibility: hidden" id="lbotp">Invalid OTP</label>
                                        </div>
                                      
                                           <button style="background-color:#0073e6" onclick="otpValidation()">Submit</button>
