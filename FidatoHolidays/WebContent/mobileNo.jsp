                                ...
                                <div class="col-md-4">
                                    ...
                                    <form action="auth/mob_otp.jsp"  method="post">
                                        <div class="form-group form-group-ghost form-group-icon-left"><i class="fa fa-user input-icon input-icon-show"></i>
                                            ...
                                            <input class="form-control" placeholder="e.g. 9876543210" type="text" name="mobile1" id=""/>
                                        </div>
                                      
                                            <button style="background-color:#0073e6">Send OTP</button>
