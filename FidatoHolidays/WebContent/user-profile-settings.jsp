...
<!-- Mirrored from remtsoy.com/tf_templates/traveler/demo_v1_7/user-profile-settings.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 16 Apr 2019 14:19:31 GMT -->
<head>
...
<body>
        ...
        <div class="demo_changer" id="demo_changer">
            ...
            <div class="form_holder">
                ...
                <div class="predefined_styles" id="styleswitch_area">
                    <a class="styleswitch" href="user-profile-settingsc392.html?default=true" style="background:#ED8323;"></a>
	...
	Class.forName("com.mysql.jdbc.Driver");
		PreparedStatement ps=con.prepareStatement("SELECT * FROM fid_reg WHERE MOBILE='"+mob+"'");
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="row">
                        <div class="col-md-5">
                            <form action="auth/update.jsp">
                                <h4>Personal Infomation</h4>
                                <div class="form-group form-group-icon-left"><i class="fa fa-user input-icon"></i>
                                    <label>First Name</label>
                                    <input class="form-control" value="<%=rs.getString("first_name") %>" type="text" name="fName"/>
                                </div>
                                <div class="form-group form-group-icon-left"><i class="fa fa-user input-icon"></i>
                                    <label>Last Name</label>
                                    <input class="form-control" value="<%=rs.getString("last_name") %>" type="text" name="lName"/>
                                </div>
                                <div class="form-group form-group-icon-left"><i class="fa fa-phone input-icon"></i>
                                    <label>Age</label>
                                    <input class="form-control" value="<%=rs.getString("dob") %>" type="text" name="age"/>
                                </div>
                                <div class="form-group form-group-icon-left"><i class="fa fa-phone input-icon"></i>
                                    <label>Gender</label>
                                    <input class="form-control" value="<%=rs.getString("gender") %>" type="text" name="gndr"/>
                                </div>
                                <div class="form-group form-group-icon-left"><i class="fa fa-envelope input-icon"></i>
                                    <label>E-mail</label>
                                    <input class="form-control" value="<%=rs.getString("email") %>" type="text" readonly="readonly"/>
                                </div>
                                <div class="form-group form-group-icon-left"><i class="fa fa-phone input-icon"></i>
                                    <label>Phone Number</label>
                                    <input class="form-control" value="<%=rs.getString("mobile") %>" type="text" readonly="readonly"/>
                                </div>
...
<!-- Mirrored from remtsoy.com/tf_templates/traveler/demo_v1_7/user-profile-settings.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 16 Apr 2019 14:19:33 GMT -->
</html>
